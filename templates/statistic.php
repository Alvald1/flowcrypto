                                        ...
                                        <div class="col p-0">
                                            <form>
                                                <select id="statuses" name="statuses">
                                                    <option value="none" selected disabled hidden>Статусы
                                                    </option>
                                                    <option value="statuses-0">новая</option>
                                                    <option value="statuses-1">ожидание платежа</option>
                                                    <option value="statuses-2">ожидание подтверждения
                                                    </option>
                                                    <option value="statuses-3">завершена</option>
                                                    <option value="statuses-4">отменена</option>
                                                    <option value="statuses-5">спор</option>
                                                </select>
                                            </form>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col p-0">
                                            <form>
                                                <select id="type" name="type">
                                                    <option value="none" selected disabled hidden>Тип оплаты
                                                    </option>
                                                    <option value="type-0">СБП</option>
                                                    <option value="type-1">Перевод на карту</option>
                                                    <option value="type-2">Перевод по номеру счета
                                                    </option>
                                                </select>
                                            </form>
                                        </div>
                                ...
                                <div class="form-group mb-2 col-md-3 col-lg-3 col-xl-2 me-2">
                                    <div class="col p-0">
                                        <select id="devices" name="devices">
                                            <option value="none" selected disabled hidden>Устройства
                                            </option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div>
                        <div class="card card-body mb-0">
                            <div class="overflow-auto">
                                <table
                                    class="table table-bordered align-middle text-left text-nowrap position-relative">
                                    <the ad>
                                        <tr>
                                            <th colspan="10" class="text-center bg-secondary text-white"><span
                                                    class="text-center mb-2 text-capitalize">всего</span>
                                                <!---->
                                                <!---->
                                            </th>
                                        </tr>
                                        ...
                                        <the ad>
                                            <tr>
                                                <th colspan="10" class="text-center text-capitalize">прием
                                                </th>
                                            </tr>
                                            </thead>
                                            <the ad>
                                                <tr class="bg-light">
                                                    <th rowspan="2" class="text-capitalize-first" style="width: 0px;">
                                                        Статус
                                                    </th>
                                                    <th rowspan="2" class="text-capitalize-first" style="width: 0px;">
                                                        Кол.
                                                    </th>
                                                    <th rowspan="2" class="text-capitalize-first text-w
              r                                     ap" style="width: 0px;">
                                                        Сумма сделок</th>
                                                    <th rowspan="2" class="text-capitalize-first text-wrap"
                                                        style="width: 0px;">
                                                        Отправленно (Трейдеры)</th>
                                                    <!---->
                                                    <!---->
                                                    <th colspan="1" class="text-center p-0">Вознаграждение</th>
                                                </tr>
                                                <tr class="bg-light">
                                                    <th class="text-capitalize-first text-center" style="width: 0px;">
                                                        трейдер</th>
                                                    <!---->
                                                    <!---->
                                                    <!---->
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th colspan="10" class="text-center text-capitalize">
                                                            выплата
                                                        </th>
                                                    </tr>
                                                </thead>
                                                <the ad>
                                                    <tr class="bg-light">
                                                        <th rowspan="2" class="text-capitalize-first"
                                                            style="width: 0px;">Статус
                                                        </th>
                                                        <th rowspan="2" class="text-capitalize-first"
                                                            style="width: 0px;">Кол.
                                                        </th>
                                                        ...
                                                        <th rowspan="2" class="text-capitalize-first text-wrap"
                                                            style="width: 0px;">
                                                            Получено (Трейдеры)</th>
                                                        <!---->
                                                        <!---->
                                                        <th colspan="1" class="text-center p-0">Вознаграждение
                                                        </th>
                                                    </tr>
                                                    <tr class="bg-light">
                                                        <th class="text-capitalize-first text-center"
                                                            style="width: 0px;">
                                                            трейдер</th>
                                                        <!---->
                                                        <!---->
